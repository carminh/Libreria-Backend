"""
Django settings for progbackend project.
...
SECRET_KEY = 'django-insecure-s#&d38l!tl_6nh%)1x0nbjo8_+#2-pv*nj#)foqi=_3@hh^z&o'
...
WSGI_APPLICATION = 'progbackend.wsgi.application'
